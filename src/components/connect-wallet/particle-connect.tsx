import { ConnectButton, useAccount, type SolanaChain, useWallets, usePublicClient } from '@particle-network/connectkit'
...
export default function ParticleConnect() {
  ...
  console.log(address, isConnected, chainId, chain)
          ...
          <>
            ...
            {balance !== null && (
              <div className="flex items-center justify-center space-x-2 mt-4">
                ...
                <button onClick={fetchBalance} className="bg-purple-500 text-white p-2 rounded">
                  🔄
                </button>
              </div>
            )}
            ...
            <button onClick={executeTx} className="bg-purple-500 text-white p-2 rounded mt-4 w-full">
            ...
            {transactionSignature && (
              <div className="mt-4">
                ...
                <p className="break-words text-blue-500">{transactionSignature}</p>
              </div>
            )}
          </>
        )}
